...
if ($maxpageno<=1) echo "<center>共有信息 <font color=red><b>{$countnum}</b></font> 条  | 只有一页";
else { 
      $nextpage=$page+1;
      $previouspage=$page-1;
	  echo "<center>共有信息 <font color=red><b>{$countnum}</b></font> 条  | ";
	  if ($page<=1) echo " <a href=?page=$nextpage>下一页</a>　<a href=?page=$maxpageno>尾页</a> ";
	  elseif($page>=$maxpageno) echo " <a href=?page=1>首页</a>　<a href=?page=$previouspage>上一页</a> ";
	 
	  else echo " <a href=?page=1>首页</a>　<a href=?page=$previouspage>上一页</a>　<a href=?page=$nextpage>下一页</a>　<a href=?page=$maxpageno>尾页</a> ";
